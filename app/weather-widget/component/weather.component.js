...
var WeatherComponent = (function () {
    ...
    WeatherComponent.prototype.getLocationName = function () {
        ...
        this.service.getLocationName(this.pos.coords.latitude, this.pos.coords.longitude)
            ...
            _this.currentCity = location["results"][1]['address_components'][1]["long_name"];
            _this.currentState = location["results"][1]['address_components'][3]["short_name"];
            console.log("Name: ", _this.currentCity + ", ", _this.currentState); // TODO: REMOVE
        });
    };
    // toggleUnits() {
